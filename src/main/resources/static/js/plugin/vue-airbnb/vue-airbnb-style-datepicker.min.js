! function(t, e) {
    ...
    var k = function(k, S) {
        if (t(k)) return new Date(k.getTime());
        if ("string" != typeof k) return new Date(k);
        var _ = (S || {}).additionalDigits;
        _ = null == _ ? n : Number(_);
        var x = function(t) {
                var e, s = {},
                    n = t.split(i);
            ...
            E = function(t, e) {
                ...
                if (s = c.exec(t)) return n = new Date(0), i = parseInt(s[1], 10) - 1, n.setUTCFullYear(e, i), n;
                if (s = l.exec(t)) {
                    n = new Date(0);
        ...
        if (E) {
            var Y, $ = E.getTime(),
                C = 0;
            return x.time && (C = function(t) {
                var n, i, r;
                if (n = D.exec(t)) return (i = parseFloat(n[1].replace(",", "."))) % 24 * e;
                if (n = g.exec(t)) return i = parseInt(n[1], 10), r = parseFloat(n[2].replace(",", ".")), i % 24 * e + r * s;
                if (n = m.exec(t)) {
                ...
                return null
            }(x.time)), x.timezone ? (I = x.timezone, Y = (O = v.exec(I)) ? 0 : (O = b.exec(I)) ? (H = 60 * parseInt(O[2], 10), "+" === O[1] ? -H : H) : (O = w.exec(I)) ? (H = 60 * parseInt(O[2], 10) + parseInt(O[3], 10), "+" === O[1] ? -H : H) : 0) : (Y = new Date($ + C).getTimezoneOffset(), Y = new Date($ + C + Y * s).getTimezoneOffset()), new Date($ + C + Y * s)
        }
        var I, O, H;
        return new Date(k)
    };
    ...
    var I = function(t) {
            var e = C(t),
                s = new Date(0);
            return s.setFullYear(e, 0, 4), s.setHours(0, 0, 0, 0), $(s)
        },
        O = 6048e5;
    var H = function(t) {
        var e = k(t),
            s = $(e).getTime() - I(e).getTime();
        return Math.round(s / O) + 1
    };
    var W = function(e) {
        if (t(e)) return !isNaN(e);
        throw new TypeError(toString.call(e) + " is not an instance of Date")
    };
    var L = ["M", "MM", "Q", "D", "DD", "DDD", "DDDD", "d", "E", "W", "WW", "YY", "YYYY", "GG", "GGGG", "H", "HH", "h", "hh", "m", "mm", "s", "ss", "S", "SS", "SSS", "Z", "ZZ", "X", "x"];
    var N = function(t) {
        var e = [];
        for (var s in t) t.hasOwnProperty(s) && e.push(s);
        var n = L.concat(e).sort().reverse();
    ...
    function K(t, e) {
        ...
        var s = t > 0 ? "-" : "+",
            n = Math.abs(t),
            i = n % 60;
        return s + P(Math.floor(n / 60), 2) + e + P(i, 2)
    }
    ...
    var z = function(t, e, s) {
        var n = e ? String(e) : "YYYY-MM-DDTHH:mm:ss.SSSZ",
            i = (s || {}).locale,
            r = B.format.formatters,
            a = B.format.formattingTokensRegExp;
        i && i.format && i.format.formatters && (r = i.format.formatters, i.format.formattingTokensRegExp && (a = i.format.formattingTokensRegExp));
        var o = k(t);
        return W(o) ? function(t, e, s) {
            var n, i, r, a = t.match(s),
                o = a.length;
            for (n = 0; n < o; n++) i = e[a[n]] || A[a[n]], a[n] = i || ((r = a[n]).match(/\[[\s\S]/) ? r.replace(/^\[|]$/g, "") : r.replace(/\\/g, ""));
            return function(t) {
                for (var e = "", s = 0; s < o; s++) a[s] instanceof Function ? e += a[s](t, A) : e += a[s];
                return e
            }
    ...
    var ot = function(t, e) {
        ...
        ut = {
            render: function() {
                ...
                return s("transition", {
                    ...
                    return s("div", {
                        ...
                        class: {
                            hidden: 0 === n || n > t.showMonths
                        },
                        style: t.monthWidthStyles
                    }, [s("div", {
                        staticClass: "asd__month-name"
                    }, [t._v(t._s(e.year) + "년 " + t._s(e.monthName))]), t._v(" "), s("table", {
                        ...
                        return s("tr", {
                            ...
                            return s("td", {
                                ...
                                class: {
                                    "asd__day--enabled": 0 !== r, "asd__day--empty": 0 === r, "asd__day--disabled": t.isDisabled(i), "asd__day--selected": i && (t.selectedDate1 === i || t.selectedDate2 === i), "asd__day--in-range": t.isInRange(i), "asd__day--today": i && t.isToday(i), "asd__selected-date-one": i && i === t.selectedDate1, "asd__selected-date-two": i && i === t.selectedDate2
                                },
            ...
            computed: {
                ...
                isDateTwoBeforeDateOne: function() {
                    return !!this.dateTwo && at(this.dateTwo, this.dateOne)
                },
            ...
            watch: {
                ...
                minDate: function() {
                    this.setStartDates(), this.generateMonths()
                },
                datePropsCompound: function(t) {
                    this.dateOne !== this.selectedDate1 && (this.startingDate = this.dateOne, this.setStartDates(), this.generateMonths()), this.isDateTwoBeforeDateOne && (this.selectedDate2 = "", this.$emit("date-two-selected", ""))
                },
                trigger: function(t, e) {
                    t && this.openDatepicker()
                }
            },
            created: function() {
            ...
            methods: {
                getDayStyles: function(t) {
                    var e = this.isSelected(t),
                        ...
                        i = {
                            ...
                            background: e ? this.colors.selected : s ? this.colors.inRange : "",
                            color: e ? this.colors.selectedText : s ? this.colors.selectedText : this.colors.text,
                            border: e ? "1px double " + this.colors.selected : s && this.allDatesSelected ? "1px double " + this.colors.inRangeBorder : ""
                        };
                    return n && (i.background = this.colors.disabled), i
                },
                getAriaLabelForDate: function(t) {
                    var e = z(t, this.dateLabelFormat);
                ...
                trapKeyboardInput: function(t) {
                    var e = Object.values(this.keys);
                    e.splice(e.indexOf(13), 1), e.indexOf(t.keyCode) > -1 && t.preventDefault()
                },
                handleKeyboardInput: function(t) {
                    ...
                    } else if (this.shouldHandleInput(t, this.keys.pgUp)) this.setFocusedDate(G(this.focusedDate, 1)), this.previousMonth();
                    else if (this.shouldHandleInput(t, this.keys.pgDn)) this.setFocusedDate(X(this.focusedDate, 1)), this.nextMonth();
                    else if (this.shouldHandleInput(t, this.keys.home)) {
                        var c = Y(this.focusedDate, {
                                weekStartsOn: this.sundayFirst ? 0 : 1
                            }),
                            l = !q(c, this.focusedDate);
                        this.setFocusedDate(c), l && this.previousMonth()
                    } else if (this.shouldHandleInput(t, this.keys.end)) {
                        var d = rt(this.focusedDate, {
                                weekStartsOn: this.sundayFirst ? 0 : 1
                            }),
                ...
                setDateFromText: function(t) {
                    if (t && !(t.length < 10)) {
                        ...
                        if (e || s) {
                            ...
                            var n = new Date(t);
                            if (W(n)) {
                                var i = z(n, this.dateFormat);
                                this.isDateDisabled(i) || this.isBeforeMinDate(i) || this.isAfterEndDate(i) || (this.startingDate = G(i, 1), this.generateMonths(), this.selectDate(i))
                            }
                        }
                    }
                },
                generateMonths: function() {
                    this.months = [];
                    for (var t = 0; t < this.showMonths + 2; t++) this.months.push(this.getMonth(this.startingDate)), this.startingDate = this.addMonths(this.startingDate)
                },
                setupDatepicker: function() {
                    if (this.$options.ariaLabels && (this.ariaLabels = ht(this.$options.ariaLabels)), this.$options.keyboardShortcuts && (this.keyboardShortcuts = ht(this.$options.keyboardShortcuts)), this.$options.dateLabelFormat && (this.dateLabelFormat = ht(this.$options.dateLabelFormat)), this.$options.sundayFirst && (this.sundayFirst = ht(this.$options.sundayFirst)), this.$options.colors) {
                        var t = ht(this.$options.colors);
                        this.colors.selected = t.selected || this.colors.selected, this.colors.inRange = t.inRange || this.colors.inRange, this.colors.selectedText = t.selectedText || this.colors.selectedText, this.colors.text = t.text || this.colors.text, this.colors.inRangeBorder = t.inRangeBorder || this.colors.inRangeBorder, this.colors.disabled = t.disabled || this.colors.disabled
                    }
                    if (this.$options.monthNames && 12 === this.$options.monthNames.length && (this.monthNames = ht(this.$options.monthNames)), this.$options.days && 7 === this.$options.days.length && (this.days = ht(this.$options.days)), this.$options.daysShort && 7 === this.$options.daysShort.length && (this.daysShort = ht(this.$options.daysShort)), this.$options.texts) {
                        var e = ht(this.$options.texts);
                ...
                setStartDates: function() {
                    ...
                    this.hasMinDate && at(t, this.minDate) && (t = this.minDate), this.startingDate = this.subtractMonths(t), this.selectedDate1 = this.dateOne, this.selectedDate2 = this.dateTwo, this.focusedDate = t
                },
                ...
                getWeeks: function(t) {
                    var e = {
                        ...
                        n = z(t, "YYYY"),
                        i = z(t, "MM"),
                        r = parseInt(z(t, this.sundayFirst ? "d" : "E"));
                    this.sundayFirst && r++;
                ...
                selectDate: function(t) {
                    if (!(this.isBeforeMinDate(t) || this.isAfterEndDate(t) || this.isDateDisabled(t))) return "single" === this.mode ? (this.selectedDate1 = t, void this.closeDatepicker()) : void(this.isSelectingDate1 || at(t, this.selectedDate1) ? (this.selectedDate1 = t, this.isSelectingDate1 = !1, at(this.selectedDate2, t) && (this.selectedDate2 = "")) : (this.selectedDate2 = t, this.isSelectingDate1 = !0, ot(this.selectedDate1, t) ? this.selectedDate1 = "" : this.showActionButtons && this.$refs["apply-button"].focus()))
                },
                setHoverDate: function(t) {
                    this.hoverDate = t
                },
                setFocusedDate: function(t) {
                    var e = z(t, this.dateFormat);
                    this.focusedDate = e;
                ...
                resetFocusedDate: function(t) {
                    if (this.focusedDate && !this.isDateVisible(this.focusedDate)) {
                        ...
                        this.focusedDate = z(r, this.dateFormat)
                    }
                },
                isToday: function(t) {
                    return z(new Date, this.dateFormat) === t
                },
                ...
                isInRange: function(t) {
                    return !(!this.allDatesSelected || this.isSingleMode) && (ot(t, this.selectedDate1) && at(t, this.selectedDate2) || ot(t, this.selectedDate1) && at(t, this.hoverDate) && !this.allDatesSelected)
                },
                isBeforeMinDate: function(t) {
                    return !!this.minDate && at(t, this.minDate)
                },
                isAfterEndDate: function(t) {
                    return !!this.endDate && ot(t, this.endDate)
                },
                isDateVisible: function(t) {
                    if (!t) return !1;
                    var e = st(this.visibleMonths[0], 1),
                        s = et(j(this.visibleMonths[this.monthsToShow - 1]), 1);
                    return ot(t, e) && at(t, s)
                },
                ...
                subtractMonths: function(t) {
                    return z(G(t, 1), this.dateFormat)
                },
                addMonths: function(t) {
                    return z(X(t, 1), this.dateFormat)
                },
        ...
        ct = {
            bind: function(t, e, s) {
                t.event = function(n) {
                    t === n.target || t.contains(n.target) || s.context[e.expression](n)
                }, document.body.addEventListener("click", t.event), document.body.addEventListener("touchstart", t.event)
            },
            unbind: function(t) {
                document.body.removeEventListener("click", t.event), document.body.removeEventListener("touchstart", t.event)
            }
        },
        lt = {
            install: function(t, e) {
                t.directive("click-outside", ct), t.component(ut.name, Object.assign({}, e, ut))
            }
        };
    return "undefined" != typeof window && window.Vue && (window.AirbnbStyleDatepicker = lt), lt
});
