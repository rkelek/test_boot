! function(t, e) {
    ...
    var ft = {
            render: function() {
                ...
                return s("transition", {
                    ...
                    return s("div", {
                        ...
                        return s("div", {
                            key: n,
                            staticClass: "asd__day-title " + (e == "일" ? "asd__day-title_red" : e == "토" ? "asd__day-title_blue" : "")
                        }, [t._v(t._s(e))])
                    }))
                })], 2), t._v(" "), s("div", {
                    ...
                    return s("div", {
                    ...
                    })) : s("span", [t._v(t._s(e.year))]), t._v("년 "), t.showMonthYearSelect ? s("select", {
                        directives: [{
                            name: "model",
                            rawName: "v-model",
                            value: e.year,
                    ...
                    })], 2) : s("span", [t._v(t._s(e.monthName))])]), t._v(" "), s("table", {
                        ...
                        return s("tr", {
                            ...
                            return s("td", {
                                ...
                                ref: "date-" + i,
                                refInFor: !0,
                                staticClass: "asd__day asd__day" + n,
                                class: [{
            ...
            data: function() {
                return {
                    ...
                    colors: {
                        ...
                        selectedText: "#fff",
                        text: "#565a5c",
                        inRangeBorder: "#91dcca",
                        disabled: "#fff",
                        hoveredInRange: "#91dcca"
                    },
                    sundayFirst: !1,
                    ariaLabels: {
            ...
            mounted: function() {
                var t, e, s, n, i = this;
                this.viewportWidth = window.innerWidth + "px", this.isMobile = false, this.isTablet = window.innerWidth >= 768 && window.innerWidth <= 1024, this._handleWindowResizeEvent = (t = function() {
            ...
            methods: {
                ...
                positionDatepicker: function() {
                    ...
                    this.viewportWidth = e + "px", this.isMobile = false, this.isTablet = e >= 768 && e <= 1024, this.showMonths = this.isMobile ? 2 : this.isTablet && this.monthsToShow > 2 ? 2 : this.monthsToShow, this.$nextTick(function() {
